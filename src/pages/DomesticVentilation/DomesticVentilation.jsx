...
import "./domesticVentilation.scss";
...
const DomesticVentilation = () => {
  ...
  return (
    <div className="domesticVentilation">
        ...
        <div className="container">
          <div className="coordinationKGAFlexClass flex-class">
            <div className="coordinationKGATexts">
              <h5>ГЛАВНАЯ / Бытовые вентиляционные установки</h5>
              <h1>Бытовые вентиляционные установки</h1>
            </div>
          </div>
          ...
          <div className="slider-container">
            {Array.isArray(dataApi.results) &&
              ...
              dataApi.results.map((dt, index) => (
                <div className="condisionerCards flex-class" key={index}>
                  <div className="condisionerCard">
          ...
          <div className="coordinationKGAFlexClass flex-class">
            <div className="coordinationKGATexts">
              <div className="condisionerTitleLeft flex-class">
                ...
                <h1>Промышленные вентиляционные установки</h1>
              </div>
              <p>
              ...
              <button className="domesticVentilationBtn">Оставить заявку</button>
            </div>
            <img
...
export default DomesticVentilation;
